...
/// Registering this before <c>AddVumaPersistence</c> is all it takes — that registration is
    ...
    : IPrincipalAccessor
{
    ...
    public string Principal
    {
        get
        {
            ...
            return user.FindFirstValue(VumaClaims.TerminalId) is { } terminal
                ? $"terminal:{terminal}"
                : _systemPrincipal;
        }
    }
    ...
    /// <inheritdoc />
    public Guid? TerminalId => ReadGuid(VumaClaims.TerminalId);
