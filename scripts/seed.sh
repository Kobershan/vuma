...
#
# Usage:
#   scripts/seed.sh                       # against ConnectionStrings:Vuma from appsettings
#   VUMA_CONNECTION="..." scripts/seed.sh
set -euo pipefail
...
exec dotnet run --project "$root/src/VumaRetail.StoreServer" -c Release -- --seed
