...
Write-Host "JWT signing key was generated and stored as a protected machine-level setting."
Write-Host "Bootstrap credentials were supplied during installation; retrieve them from the secure installation record."
Write-Host "After creating the real administrator, deactivate the bootstrap account and remove VUMA_BOOTSTRAP_PASSWORD."
