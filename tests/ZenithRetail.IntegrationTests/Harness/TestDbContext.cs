...
/// <summary>
/// Builds <see cref="ZenithRetailDbContext"/> over a test database, with a controllable clock,
/// principal and tenant.
/// </summary>
/// <remarks>
/// A factory rather than a subclass. EF resolves both the migrations assembly and the model snapshot
/// from the <em>runtime</em> context type, so a <c>TestDbContext : ZenithRetailDbContext</c> would be
...
public static class TestDbContextFactory
{
    ...
    public static ZenithRetailDbContext For(
        string connectionString,
        IClock? clock = null,
        IPrincipalAccessor? principal = null,
        ITenantContext? tenant = null)
        => new(
            BuildOptions<ZenithRetailDbContext>(connectionString, clock, principal),
        ...
        where TContext : DbContext
    {
        ...
        options.UseNpgsql(connectionString, npgsql =>
        {
            ...
            npgsql.MigrationsAssembly(typeof(ZenithRetailDbContext).Assembly.FullName);
        });
...
/// </para>
/// </remarks>
public sealed class ProbeDbContext : ZenithRetailDbContext
{
