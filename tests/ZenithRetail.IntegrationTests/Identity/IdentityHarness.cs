...
{
    private IdentityHarness(ZenithRetailDbContext context, TestTenantContext tenant, TestClock clock, Guid tenantId, Guid storeId)
    {
        Context = context;
    ...
    public ZenithRetailDbContext Context { get; }
    ...
    public static async Task<IdentityHarness> CreateAsync(PostgresFixture fixture)
    {
        ...
        ZenithRetailDbContext context = TestDbContextFactory.For(
            connectionString,
            clock,
