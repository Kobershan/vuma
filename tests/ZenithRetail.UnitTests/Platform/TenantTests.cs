...
public sealed class TenantTests
{
    ...
    public void A_new_tenant_carries_the_South_African_deployment_defaults()
    {
        ...
        Tenant tenant = Tenant.CreateWithSouthAfricanDefaults("Zenith Foods (Pty) Ltd", "Zenith Foods");
    ...
    {
        Action creating = () => Tenant.CreateWithSouthAfricanDefaults(legalName, "Zenith Foods");
    ...
    public void A_tenant_outside_South_Africa_supplies_its_own_localisation()
    {
        Tenant tenant = Tenant.Create(
            "Zenith Foods Ltd", "Zenith Foods", "en-GB", "gbp", "Europe/London");
