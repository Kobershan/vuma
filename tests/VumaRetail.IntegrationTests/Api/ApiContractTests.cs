...
public sealed class ApiContractTests(PostgresFixture fixture)
{
    ...
    public async Task Every_warehouse_operation_reaches_the_openapi_document()
    {
        ...
        foreach (string path in new[]
        {
            ...
            "/api/v1/assets/",
            "/api/v1/assets/{id}/place-in-service",
            "/api/v1/assets/{id}/dispose",
            "/api/v1/assets/{id}/books",
            "/api/v1/assets/books/{id}/depreciation",
            "/api/v1/maintenance/orders/",
            "/api/v1/maintenance/orders/{id}/start",
            "/api/v1/maintenance/orders/{id}/complete",
