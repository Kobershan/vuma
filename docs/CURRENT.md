...
CURRENT STAGE: Stage 16 — BOM Setup — IN PROGRESS (2026-09-10). Domain lifecycle and EF persistence are implemented and verified; API, explosion/costing, seed, and stage exit verification remain open.
