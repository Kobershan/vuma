...
TEST STATUS: Unit tests 827 passed; architecture tests 35 passed; infrastructure build succeeded with 0 errors; targeted migration tests failed at PostgreSQL fixture startup because Docker and the local PostgreSQL endpoint are unavailable.
