...
TEST STATUS: Unit tests — 841 passed; architecture tests — 35 passed; integration tests — 24 passed, 403 blocked by unavailable PostgreSQL/Docker (`Docker is either not running or misconfigured`, rerun 2026-08-28); `git diff --check` — passed.
