...
tests pass 10/10 and StoreServer Release builds with 0 errors; approved swaps now apply atomically
after target conflict and owner-change checks. Roster publication and labour-cost integration remain
open.
