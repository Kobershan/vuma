...
| 07 | Financial Core: GL, AR, AP, Banking, Tax ★ | 06 | The accounting spine. Without it this is not an ERP — **WIP, branch `stage-07-finance` (3 commits: posting/tax engine, AR/AP/banking, reporting queries), not yet merged** |
