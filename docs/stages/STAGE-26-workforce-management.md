...
Verification recorded 2026-09-13: `HrStagesRulesTests` (6/6) and `HrLifecycleTests` (5/5) pass. Shift creation refuses an overlapping non-cancelled shift for the same employee; roster/availability, swaps and labour-cost integration remain open.
