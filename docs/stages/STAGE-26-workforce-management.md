...
2026-09-13: Added the `ShiftSwapRequest` approval state machine and same-employee/decide-once
invariants; `HrLifecycleTests` now passes 7/7. Swap persistence, authorization, roster publication
