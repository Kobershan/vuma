...
|---|---|---|---|
| TASK-17-001 | Production-order lifecycle and BOM snapshot | Stage 16 | READY |
| TASK-17-002 | Material issue, output receipt, scrap, stock and financial integration | TASK-17-001 | NOT_STARTED |
