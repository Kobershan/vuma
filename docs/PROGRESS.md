...
| 17 | Manufacturing | **IN PROGRESS** — production lifecycle, stock-backed issue/output, replay protection, API, genealogy and capacity readback implemented; shortage/journal, backup/seed and specialist closure evidence remain | 2026-09-13 |
...
| 21 | Ecommerce, storefront API & channels | **IN PROGRESS** — channel identity, published-product persistence/read/publication routes and tenant-scoped basket foundation implemented; checkout, payment/webhooks and full acceptance evidence remain | 2026-09-13 |
