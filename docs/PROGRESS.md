...
| 08b | Design system & theming | **COMPLETE** — TASK-08B-001 (tokens.json, generators, WPF themes, Android Compose, CSS tokens, architecture test) + TASK-08B-002 (40+ components, till line list, stat tile, Vuma tick, gallery, tests). Blocked on Windows/WPF for runtime verification. | 2026-09-07 |
