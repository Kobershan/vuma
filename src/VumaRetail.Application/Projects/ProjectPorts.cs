...
public interface IProjectRepository
{
    ...
    Task<RebateAgreement?> FindRebateAsync(Guid id, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<RebateAgreement>> ListRebatesAsync(Guid companyId, CancellationToken cancellationToken = default);
    ...
    void Add(RebateAgreement agreement);
}
