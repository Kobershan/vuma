...
public sealed record SetGroupRetailPriceRequest(Guid BusinessId, Guid CompanyId, Guid ItemId, decimal BasePrice, decimal? LocalOverride, string Currency);
public sealed record SetFranchiseWholesalePriceRequest(Guid BrandCompanyId, Guid FranchiseeCompanyId, Guid ItemId, decimal FlatPrice, decimal? FranchiseeOverride, string Currency);
public sealed record SetSharedPremisesRetailPriceRequest(Guid PremisesId, Guid CompanyId, Guid ItemId, decimal RetailPrice, string Currency);
