...
public sealed record CreateTransferLineRequest(Guid? ItemId, Guid? ItemVariantId, decimal Quantity, string UnitOfMeasure, Guid SenderLocationId, Guid? ReceiverLocationId = null, string? BatchReference = null, DateOnly? ExpiryDate = null, string? SerialNumber = null);
