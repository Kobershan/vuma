...
public sealed record ProvisionCompanyRequest(Guid CompanyId, string Code, string LegalName, string TradingName, string BaseCurrency, string Locale, string DocumentPrefix);
