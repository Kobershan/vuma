...
public class VumaRetailDbContext : DbContext, IUnitOfWork
{
    ...
    public DbSet<Domain.Ecommerce.CommerceBasket> CommerceBaskets => Set<Domain.Ecommerce.CommerceBasket>();

    public DbSet<Domain.Ecommerce.CommerceBasketLine> CommerceBasketLines => Set<Domain.Ecommerce.CommerceBasketLine>();
    ...
    public DbSet<Domain.Assets.StoreChecklist> StoreChecklists => Set<Domain.Assets.StoreChecklist>();
    public DbSet<Domain.Assets.ChecklistExecution> ChecklistExecutions => Set<Domain.Assets.ChecklistExecution>();
