...
public sealed class DisciplinaryCaseRepository(VumaRetailDbContext db) : IDisciplinaryCaseRepository { public Task<DisciplinaryCase?> FindAsync(Guid id, CancellationToken t = default) => db.DisciplinaryCases.SingleOrDefaultAsync(x => x.Id == id, t); public void Add(DisciplinaryCase @case) => db.DisciplinaryCases.Add(@case); }
