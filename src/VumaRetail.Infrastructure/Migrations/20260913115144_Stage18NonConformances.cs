...
{
    /// <inheritdoc />
    public partial class Stage18NonConformances : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "ix_non_conformances_sync_state",
                schema: "quality",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_non_conformances_tenant_company_status",
                schema: "quality",
                table: "non_conformances",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_non_conformances_tenant_id",
                schema: "quality",
                table: "non_conformances",
                column: "tenant_id");

            migrationBuilder.CreateIndex(
                name: "ix_non_conformances_tenant_id_company_id",
                schema: "quality",
                table: "non_conformances",
                columns: new[] { "tenant_id", "company_id" });

            migrationBuilder.CreateIndex(
                name: "ix_non_conformances_tenant_id_store_id",
                schema: "quality",
                table: "non_conformances",
                columns: new[] { "tenant_id", "store_id" });

            migrationBuilder.CreateIndex(
                name: "ux_non_conformances_tenant_operation",
                schema: "quality",
                table: "non_conformances",
