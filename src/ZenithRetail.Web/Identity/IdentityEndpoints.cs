...
using ZenithRetail.Contracts.Identity;
...
public static class IdentityEndpoints
{
    ...
    public static IEndpointRouteBuilder MapZenithIdentity(this IEndpointRouteBuilder endpoints)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        Guid? storeId = ReadGuid(caller, ZenithClaims.StoreId);
