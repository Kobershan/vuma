...
namespace ZenithRetail.Infrastructure.Persistence.Repositories;
...
/// every entity by <see cref="ZenithRetailDbContext"/>. Adding a second predicate here would hide a
/// bug in the first one rather than defending against it.
/// </para>
/// </remarks>
/// <param name="context">The database context.</param>
public sealed class UserRepository(ZenithRetailDbContext context) : IUserRepository
{
    /// <inheritdoc />
...
/// <param name="context">The database context.</param>
public sealed class RoleRepository(ZenithRetailDbContext context) : IRoleRepository
{
    /// <inheritdoc />
...
public sealed class TerminalRepository(ZenithRetailDbContext context, ITenantContext tenantContext) : ITerminalRepository
{
    /// <inheritdoc />
...
public sealed class RefreshTokenRepository(ZenithRetailDbContext context, ITenantContext tenantContext)
