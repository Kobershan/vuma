...
public static class ConnectEndpoints
{
    public static IEndpointRouteBuilder MapVumaConnect(this IEndpointRouteBuilder endpoints)
    {
        ...
        api.MapGet("/connections/{id:guid}/granted-users", async (Guid id, IDispatcher d, CancellationToken ct) =>
            TypedResults.Ok(await d.QueryAsync(new ListSupplierPortalGrantsQuery(id), ct))).RequirePermission(ConnectPermissions.View);
